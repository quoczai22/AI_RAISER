...
assert.equal(publicAppSource.includes("SpeechRecognition"), true);
assert.equal(publicAppSource.includes("voice-input"), true);
assert.equal(publicAppSource.includes("voice-name"), true);
